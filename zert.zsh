...
autoload -Uz _zert_plugin_sanitize_id _zert_parse_flags _zert_lockfile_read_entry _zert_lockfile_write_entry _zert_lockfile_remove_entry _zert_rm _zert_resolve_plugin_name _zert_display_name
autoload -Uz _zert_plugin_ensure_exists _zert_plugin_clone _zert_plugin_ensure_sync _zert_plugin_checkout _zert_plugin_pull _zert_plugin_update _zert_plugin_compile _zert_plugin_source _zert_source_file _zert_lockfile_iterate _zert_run_subtask
