...
Если Zert вам полезен, рассмотрите возможность поставить звезду на [GitHub](https://github.com/oxcl/zert) или сделать [пожертвование](https://oxcl.github.io/zert/#donate).


## 🔄 Сравнение

Экосистема менеджеров плагинов Zsh велика — Antidote, Zinit, Sheldon, Zgenom, Zim и другие используют разные подходы к одной и той же задаче. Большинство достаточно быстры, чтобы разницы в производительности были незаметны. Значимые различия сводятся к стилю конфигурации, воспроизводимости и модели зависимостей. Zert — единственный менеджер на чистом Zsh с инлайн-объявлениями и lock-файлом для воспроизводимых установок. Подробное сравнение см. в [документе сравнения](./COMPARISON_ru.md).
